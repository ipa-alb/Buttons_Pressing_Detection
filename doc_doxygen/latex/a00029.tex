...
\begin{DoxyReturn}{Returns}
the change of state of the button, for how long it was pressed and the datetime it is not pressed anymore 
\end{DoxyReturn}
...
\begin{DoxyReturn}{Returns}
a loop fort the thread to run in or stop the test when the time of the test is completed 
\end{DoxyReturn}
